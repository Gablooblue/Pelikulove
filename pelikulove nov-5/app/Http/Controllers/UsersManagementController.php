...
class UsersManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($pagintaionEnabled) {
            $users = User::orderBy('created_at', 'desc')->paginate(config('usersmanagement.paginateListSize'));
        } else {
            $users = User::all();
        }
    ...
    public function store(Request $request)
    {
		...
		if (isset($token)) Notification::send($user, new SendWelcomeEmail($token,$user));	
