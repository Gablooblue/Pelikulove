...
class SendDailyStatsTemp extends Notification implements ShouldQueue
{
    use Queueable;

	protected $userData, $vodData, $courseData, $date;

    /**
     * Create a new notification instance.
     */
    public function __construct($userData, $vodData, $courseData, $date)
    {
    ...
    public function toMail($notifiable)
    {
        ...
        $message->subject(trans('[Pelikulove] Stats for '. $date ))
            ->greeting(trans('Here are the Stats for '. $date ))
