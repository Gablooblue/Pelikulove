...
|
*/
// Route::get('/test04','TestsController@test01')->name('tests.test04');	
...
Route::group(['middleware' => ['web', 'activity', 'checkblocked']], function () {
	...
	Route::get('/courses','CourseController@catalog')->name('course.catalog');
    ...
    // Ricky Lee pages
    // Route::get('/trip2quiapo-registration', 'Auth\SpecialRegistrationController@createRickyLee')->name('registration.createrickylee'); 
    // Route::post('/trip2quiapo-registration/store', 'Auth\SpecialRegistrationController@storeRickyLee')->name('registration.storerickylee'); 
    Route::get('/tambayan-with-ricky-lee', 'Auth\LoginController@tambayanWithRLLogin')->name('login.tambayanwithrl'); 
    Route::get('/tambayan-with-ricky-lee/register', 'Auth\SpecialRegistrationController@newCreateRickyLee')->name('registration.newcreaterickylee'); 
    Route::post('/tambayan-with-ricky-lee/register/store', 'Auth\SpecialRegistrationController@newStoreRickyLee')->name('registration.newstorerickylee'); 
...
Route::group(['middleware' => ['auth', 'activity', 'checkblocked']], function () {
    ...
    // Ricky Lee pages
    // Route::get('/tambayan-with-ricky-lee/profile', 'Auth\SpecialRegistrationController@updateRickyLee')->name('registration.updaterickylee'); 
    Route::get('/activate-ricky-lee', 'Auth\ActivateController@initialRickyLee')->name('activate.rickylee');
    Route::post('/tambayan-with-ricky-lee/profile/store', 'Auth\SpecialRegistrationController@storeRickyLeeProfile')->name('registration.storerickyleeprofile'); 
    // Route::get('/activate-rl/{token}', 'Auth\ActivateController@activateRickyLee')->name('authenticated.activaterickylee');
...
Route::group(['middleware' => ['auth', 'activated', 'activity', 'twostep', 'checkblocked']], function () {
    ...
    // Route::get('getData1', 'TestsController@getData1');   
});
...
Route::group(['middleware' => ['auth', 'activated', 'currentUser', 'activity', 'twostep', 'checkblocked']], function () {
    ...
    // Temporary course routes
	Route::get('/course/3/workshop-guidelines','CourseController@rkGuidelines')->name('course.guidelines');
	Route::get('/course/3/groupings','CourseController@rkGroupings')->name('course.groupings');
	...
	// Routing of Vod Purchases
    Route::get('/vod-purchases','VodOwnerController@index')->name('vod-purchases');
	// Route::get('/enrollees/{vod}','EnrolleeController@show')->name('enrollees.show');
	
	// Submissions
	Route::get('/submissions','SubmissionController@catalog')->name('submissions.catalog');
	...
	Route::get('/submission/{uuid}/download', 'SubmissionController@download')->name('submission.download');
    ...
    // Donations
    Route::get('/donations','DonationController@create')->name('donations.create');	
    Route::post('/donations/store','DonationController@store')->name('donations.store');

    // Temp URL
    Route::get('subtitles-test', 'TestsController@subtitlesTest')->name('test.subtitles');
});
...
Route::group(['middleware' => ['auth', 'activated', 'role:admin|pelikulove',  'activity', 'twostep', 'checkblocked']], function () {
    ...
    // Vod Admin
    // Slideshows
    Route::get('/blackbox-admin','VodAdminManagementController@index')->name('vodsmanagement.blackbox-admin');
    Route::get('/blackbox-admin/slideshow/edit/{category_id}','VodAdminManagementController@editSlideshow')->name('vodsmanagement.edit-slideshow');
    // Categories
    Route::get('/blackbox-admin/category/create','VodAdminManagementController@createCategory')->name('vodsmanagement.createCategory');
    Route::post('/blackbox-admin/category/store','VodAdminManagementController@storeCategory')->name('vodsmanagement.storeCategory');
    Route::get('/blackbox-admin/category/edit/{category_id}','VodAdminManagementController@editCategory')->name('vodsmanagement.editCategory');
    Route::post('/blackbox-admin/category/update/{category_id}','VodAdminManagementController@updateCategory')->name('vodsmanagement.updateCategory');
    Route::get('/blackbox-admin/category/rearrange','VodAdminManagementController@rearrangeCategory')->name('vodsmanagement.rearrangeCategory');
    Route::post('/blackbox-admin/category/store-rearranged','VodAdminManagementController@storeRearrangedCategory')->name('vodsmanagement.storeRearrangedCategory');
    Route::get('/blackbox-admin/category/remove/{category_id}','VodAdminManagementController@removeCategory')->name('vodsmanagement.removeCategory');
    Route::get('/blackbox-admin/category/{category_id}','VodAdminManagementController@showCategory')->name('vodsmanagement.showCategory');
    // Videos
    Route::get('/blackbox-admin/category/{category_id}/vod/rearrange','VodAdminManagementController@rearrangeCategoryVods')->name('vodsmanagement.rearrangeCategoryVods');
    Route::post('/blackbox-admin/category/{category_id}/vod/store-rearranged','VodAdminManagementController@storeRearrangedCategoryVods')->name('vodsmanagement.storeRearrangedCategoryVods');
    Route::get('/blackbox-admin/category/{category_id}/vod/create','VodAdminManagementController@createVod')->name('vodsmanagement.createVod');
    Route::post('/blackbox-admin/category/{category_id}/vod/store','VodAdminManagementController@storeVod')->name('vodsmanagement.storeVod');
    Route::get('/blackbox-admin/category/{category_id}/vod/edit/{vod_id}','VodAdminManagementController@editVod')->name('vodsmanagement.editVod');
    Route::post('/blackbox-admin/category/{category_id}/vod/update/{vod_id}','VodAdminManagementController@updateVod')->name('vodsmanagement.updateVod');
    Route::delete('/blackbox-admin/category/{category_id}/vod/remove/{vod_id}','VodAdminManagementController@removeVod')->name('vodsmanagement.removeVod');
    // Services
    Route::get('/blackbox-admin/category/{category_id}/vod/{vod_id}/services','VodAdminManagementController@showServices')->name('vodsmanagement.showServices');
    Route::get('/blackbox-admin/category/{category_id}/vod/{vod_id}/services/create','VodAdminManagementController@createService')->name('vodsmanagement.createService');
    Route::post('/blackbox-admin/category/{category_id}/vod/{vod_id}/services/store','VodAdminManagementController@storeVodService')->name('vodsmanagement.storeVodService');
    Route::get('/blackbox-admin/category/{category_id}/vod/{vod_id}/services/edit/{service_id}','VodAdminManagementController@editVodService')->name('vodsmanagement.editVodService');
    Route::post('/blackbox-admin/category/{category_id}/vod/{vod_id}/services/update/{service_id}','VodAdminManagementController@updateVodService')->name('vodsmanagement.updateVodService');
    ...
    // Analytics Vod
    Route::get('/analytics/vod','AnalyticsController@showVods')->name('analytics.vod');
    ...
    Route::get('/analytics/vod/video/{id}','AnalyticsController@showVideo')->name('analytics.vod.show-video');
    Route::post('/analytics/vod','AnalyticsController@showVods')->name('analytics.vod');
    ...
    Route::post('/analytics/vod/video/{id}','AnalyticsController@showVideo')->name('analytics.vod.show-video');

    // Analytics Courses
    Route::get('/analytics/courses','AnalyticsController@showCourses')->name('analytics.courses');
    Route::post('/analytics/courses','AnalyticsController@showCourses')->name('analytics.courses');
    Route::get('/analytics/course/{course_id}/show','AnalyticsController@showCourse')->name('analytics.course');
    Route::post('/analytics/course/{course_id}/show','AnalyticsController@showCourse')->name('analytics.course');

    Route::get('/analytics/users','AnalyticsController@showEnrolleesAndRegistrants')->name('analytics.users');
    Route::post('/analytics/users','AnalyticsController@showEnrolleesAndRegistrants')->name('analytics.users');
    ...
    // Donations
    Route::get('/donations/list','DonationController@index')->name('donations.list');	
    Route::get('/donations/{id}/show','DonationController@show')->name('donations.show');	

    // Event logs
    Route::get('/eventlogs','EventLogsController@index')->name('eventlogs.index');	
    Route::get('/eventlogs/{id}','EventLogsController@show')->name('eventlogs.show');	

    // SEO
    Route::get('/sitemap-generate', 'SEOController@generate')->name('seo.gen');

    // Catalog Analytics
    Route::get('/analytics-catalog', 'UserController@catalogAnalytics')->name('catalog.analytics');

    // Catalog Admin
    Route::get('/admin-catalog', 'UserController@catalogAdmin')->name('catalog.admin');
});
