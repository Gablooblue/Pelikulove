                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-4 col-md-3 profile-sidebar text-white rounded-left-sm-up">
                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link @if ($focus == 'profile') active @endif" data-toggle="pill" href=".edit-profile-tab" role="tab" aria-controls="edit-profile-tab" aria-selected="@if ($focus == 'profile') true @else false @endif">
                                                {{ trans('profile.editProfileTitle') }}
                                            </a>
                                            <a class="nav-link @if ($focus == 'settings') active @endif" data-toggle="pill" href=".edit-settings-tab" role="tab" aria-controls="edit-settings-tab" aria-selected="@if ($focus == 'settings') true @else false @endif">
                                                {{ trans('profile.editAccountTitle') }}
                                            </a>
                                            <a class="nav-link @if ($focus == 'account') active @endif" data-toggle="pill" href=".edit-account-tab" role="tab" aria-controls="edit-settings-tab" aria-selected="@if ($focus == 'account') true @else false @endif">
                                                {{ trans('profile.editAccountAdminTitle') }}
                                            </a>
                                            <a class="nav-link @if ($focus == 'notif') active @endif" data-toggle="pill" href=".edit-notif-settings-tab" role="tab" aria-controls="edit-notif-settings-tab" aria-selected="@if ($focus == 'notif') true @else false @endif">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade @if ($focus == 'profile') show active @endif edit-profile-tab" role="tabpanel" aria-labelledby="edit-profile-tab">
                                                <div class="row mb-1">
                                                    <div class="col-sm-12">
                                            ...
                                            <div class="tab-pane fade @if ($focus == 'settings') show active @endif edit-settings-tab" role="tabpanel" aria-labelledby="edit-settings-tab">
                                            ...
                                            <div class="tab-pane fade @if ($focus == 'account') show active @endif edit-account-tab" role="tabpanel" aria-labelledby="edit-account-tab">
                                            ...
                                            {{-- New Notif Settings Tab --}}
                                            <div class="tab-pane fade @if ($focus == 'notif') show active @endif edit-notif-settings-tab" role="tabpanel" aria-labelledby="edit-notif-settings-tab">
                                                {!! Form::model($user, array('action' => array('ProfilesController@updateNotifSettings', $user->id), 'method' => 'POST', 'id' => 'user_notif_form')) !!}

                                                    {!! csrf_field() !!}

                                                    <div class="pt-4 pr-3 pl-2 form-group has-feedback row {{ $errors->has('tambayanChkbx') ? ' has-error ' : '' }}">
                                                        <div class="col-md-4">
                                                            {!! Form::label('tambayanChkbx', 'Tambayan Forum Emails', array('class' => 'control-label')); !!}
                                                        </div>
                                                        <div class="col-md-8">
                                                            @php $checkT1 = 'checked'; if(App\Models\NotifPreferences::getTambayanEmailPref(Auth::user()->id) != 1) $checkT1 = '' @endphp
                                                            {!! Form::input('checkbox', 'tambayanChkbx', NULL, array('id' => 'tambayanChkbx', 'style' => 'width: 20px; height: 20px;', $checkT1)) !!}                                                            
                                                            @if($errors->has('tambayanChkbx'))
                                                                <span class="help-block">
                                                                    <strong>{{ $errors->first('tambayanChkbx') }}</strong>
                                                                </span>
                                                            @endif
                                                        </div>
                                                    </div> 

                                                    <div class="pt-4 pr-3 pl-2 form-group has-feedback row {{ $errors->has('saluhanChkbx') ? ' has-error ' : '' }}">
                                                        <div class="col-md-4">
                                                            {!! Form::label('saluhanChkbx', 'Saluhan Workspace Emails', array('class' => 'control-label')); !!}
                                                        </div>
                                                        <div class="col-md-8">
                                                            @php $checkS1 = 'checked'; if(App\Models\NotifPreferences::getSaluhanEmailPref(Auth::user()->id) != 1) $checkS1 = '' @endphp
                                                            {!! Form::input('checkbox', 'saluhanChkbx', NULL, array('id' => 'saluhanChkbx', 'style' => 'width: 20px; height: 20px;', $checkS1)) !!}                                                            
                                                            @if($errors->has('saluhanChkbx'))
                                                                <span class="help-block">
                                                                    <strong>{{ $errors->first('saluhanChkbx') }}</strong>
                                                                </span>
                                                            @endif
                                                        </div>
                                                    </div> 

                                                    <div class="pt-4 pr-3 pl-2 form-group has-feedback row {{ $errors->has('topicChkbx') ? ' has-error ' : '' }}">
                                                        <div class="col-md-4">
                                                            {!! Form::label('topicChkbx', 'Lesson Comment Emails', array('class' => 'control-label')); !!}
                                                        </div>
                                                        <div class="col-md-8">
                                                            @php $checkS1 = 'checked'; if(App\Models\NotifPreferences::getTopicEmailPref(Auth::user()->id) != 1) $checkS1 = '' @endphp
                                                            {!! Form::input('checkbox', 'topicChkbx', NULL, array('id' => 'topicChkbx', 'style' => 'width: 20px; height: 20px;', $checkS1)) !!}                                                            
                                                            @if($errors->has('topicChkbx'))
                                                                <span class="help-block">
                                                                    <strong>{{ $errors->first('topicChkbx') }}</strong>
                                                                </span>
                                                            @endif
                                                        </div>
                                                    </div>

                                                    <div class="pt-4 pr-3 pl-2 form-group has-feedback row {{ $errors->has('vodChkbx') ? ' has-error ' : '' }}">
                                                        <div class="col-md-4">
                                                            {!! Form::label('vodChkbx', 'Blackbox Comment Emails', array('class' => 'control-label')); !!}
                                                        </div>
                                                        <div class="col-md-8">
                                                            @php $checkS1 = 'checked'; if(App\Models\NotifPreferences::getVodEmailPref(Auth::user()->id) != 1) $checkS1 = '' @endphp
                                                            {!! Form::input('checkbox', 'vodChkbx', NULL, array('id' => 'vodChkbx', 'style' => 'width: 20px; height: 20px;', $checkS1)) !!}                                                            
                                                            @if($errors->has('vodChkbx'))
                                                                <span class="help-block">
                                                                    <strong>{{ $errors->first('vodChkbx') }}</strong>
                                                                </span>
                                                            @endif
                                                        </div>
                                                    </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $('#user_notif_form').on('keyup change', 'input, select, textarea', function(){
            $('#notif_save_trigger').attr('disabled', false).removeClass('disabled').show();
        });
