        ...
        <div class="card shadow bg-white rounded ">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('payment.process')}}">
                    {{ csrf_field() }}
                    @if (isset($order))<input type="hidden" name="order_id" value="{{encrypt($order->id)}}">@endif
                    <h5> Rates</h5>
...
$(document).ready(function(){
    ...
    $('#code').change(function(e){  		
        ...
        $.get("/ajax/check/"+ code +"/", function(data){
            ...
            if (data.amount == undefined) {
                ...
                $('#service_id_' + data.service_id).prop("checked", true);
                $('#amount').empty();
