...
@section('template_title')
    Showing Services for {{ $services[0]->title }}
@endsection
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="div-title" style="display: flex; justify-content: space-between; align-items: center;">
                                <div class="pull-right">
                                    ...
                                    <br>
                                    <a href="{{ url('/blackbox-admin/category/' . $services[0]->category_id) }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="Back to Category">
                                ...
                                <div class="btn-group pull-right btn-group-xs">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ url('blackbox-admin/category/' . $services[0]->category_id . '/vod/' . $services[0]->vod_id . '/services/create') }}">
                                ...
                                <tbody id="services_table">
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-info btn-block" href="{{ url('blackbox-admin/category/' . $service->category_id . '/vod/' . $service->vod_id . '/services/edit/' . $service->id) }}" data-toggle="tooltip" title="Edit">
