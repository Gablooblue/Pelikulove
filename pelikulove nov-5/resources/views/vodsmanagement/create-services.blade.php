                ...
                <div class="card">
                    ...
                    <div class="card-body div-payment-methods">		
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('video') ? ' has-error ' : '' }}"
                            data-toggle="tooltip" data-html="true" title="Leaving this empty will prevent the video from being diplayed on the catalog <br>File name must not have special characters except for periods, dashes and underscores">
