...
<div class="container">
		...
		<div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    {!! Form::open(array('route' => ['vodsmanagement.updateVod', $category->id, $vod->id], 'method' => 'POST', 'new-vod' => 'form', 'class' => 'needs-validation')) !!}
                    ...
                    <div class="card-body div-payment-methods">		
                        <div class="form-group has-feedback row {{ $errors->has('title') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                ...
                                {!! Form::text('title', $vod->title , array('id' => 'title', 'class' => 'form-control', 'placeholder' => 'Video Title', 'required')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('short_title') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::text('short_title', $vod->short_title , array('id' => 'short_title', 'class' => 'form-control', 'placeholder' => 'Video Short Title', 'required')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::textarea('description', $vod->description , array('id' => 'description', 'class' => 'form-control', 'placeholder' => 'This Video is about... <br> <hr> <a href="google.com">Click here for google</a>')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description_2') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::textarea('description_2', $vod->description_2 , array('id' => 'description_2', 'class' => 'form-control', 'placeholder' => 'This Video is about...')) !!}
                                    <div class="input-group-append">
                        ...
                        {{-- <div class="form-group has-feedback row {{ $errors->has('information') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::textarea('information', $vod->information , array('id' => 'information', 'class' => 'form-control', 'placeholder' => 'Casts, Directors, etc...', 'required')) !!}
                                    <div class="input-group-append">
                        ...
                        {{-- <div class="form-group has-feedback row {{ $errors->has('maturity_rating') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::text('maturity_rating', $vod->maturity_rating , array('id' => 'maturity_rating', 'class' => 'form-control', 'placeholder' => 'ie: PG-13')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('year_released') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::input('number', 'year_released', $vod->year_released , array('id' => 'year_released', 'class' => 'form-control', 'placeholder' => 'ie: 2020', 'min' => '1000', 'max' => '3000')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('duration') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::input('number', 'duration', $vod->duration , array('id' => 'duration', 'class' => 'form-control', 'placeholder' => '120 mins', 'min' => '1', 'max' => '999', 'required')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('hidden') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                {{-- <div class=""> --}}
                                    @php $checkHidden = 'checked'; if($vod->hidden != 1) $checkHidden = '' @endphp
                                    {!! Form::input('checkbox', 'hidden', NULL, array('id' => 'hidden', $checkHidden, 'class' => 'form-control', 'style' => 'width: 20px; height: 100%;')) !!} 
                                {{-- </div> --}}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('private') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                {{-- <div class=""> --}}
                                    @php $checkPrivate = 'checked'; if($vod->private != 1) $checkPrivate = '' @endphp
                                    {!! Form::input('checkbox', 'private', NULL, array('id' => 'private', $checkPrivate, 'class' => 'form-control', 'style' => 'width: 20px; height: 100%;')) !!} 
                                {{-- </div> --}}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('donate_btn') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                {{-- <div class=""> --}}
                                    @php $checkDonate = 'checked'; if($vod->donate_btn != 1) $checkDonate = '' @endphp
                                    {!! Form::input('checkbox', 'donate_btn', NULL , array('id' => 'donate_btn', $checkDonate, 'class' => 'form-control', 'style' => 'width: 20px; height: 100%;')) !!} 
                                {{-- </div> --}}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('thumbnail') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::text('thumbnail', $vod->video, array('id' => 'thumbnail', 'class' => 'form-control', 'placeholder' => 'image-thumbnail.jpg', 'required')); !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('video') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::text('video', $vod->video , array('id' => 'video', 'class' => 'form-control', 'placeholder' => 'sample-video.mp4')); !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('transcript') ? ' has-error ' : '' }}"
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::text('transcript', $vod->transcript , array('id' => 'transcript', 'class' => 'form-control', 'placeholder' => 'sample-transcript.vtt')); !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('paid') ? ' has-error ' : '' }}"
                            data-toggle="tooltip" data-html="true" title="If it's the Video's first time being a paid one, the Service Form will pop up otherwise the old Video's service will be used">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <select class="custom-select form-control" name="paid" id="paid">                                        
                                        <option value=0 {{$free}}>Free</option>
                            ...
                            <div class="paid-div card rounded m-2" style="display: none;"> 
                                <div class="card-body">       
                                    ...
                                    <div class="form-group has-feedback row {{ $errors->has('s_name') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                            {!! Form::text('s_name', $vod->s_name , array('id' => 's_name', 'class' => 'form-control', 'placeholder' => 'Basic Package')); !!}
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group has-feedback row {{ $errors->has('s_description') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                            {!! Form::text('s_description', $vod->s_description , array('id' => 's_description', 'class' => 'form-control', 'placeholder' => 'Gives you access to the Boses Film for 3 days')); !!}
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group has-feedback row {{ $errors->has('s_duration') ? ' has-error ' : '' }}"
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                {!! Form::input('number', 's_duration', $vod->s_duration , array('id' => 's_duration', 'class' => 'form-control', 'placeholder' => '3', 'min' => '1', 'max' => '999')) !!}
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group has-feedback row {{ $errors->has('amount') ? ' has-error ' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                {!! Form::input('number', 'amount', $vod->amount , array('id' => 'amount', 'class' => 'form-control', 'placeholder' => '₱500', 'min' => '1', 'max' => '999999')) !!}
                                                <div class="input-group-append">
