                ...
                <div class="card">
                    <div class="card-header">
                        <div class="div-title" style="display: flex; justify-content: space-between; align-items: center;">
                            Editing Service for {{ $vod->title }} <br> 
                            <br>
                            {!! $service->name !!}
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => ['vodsmanagement.updateVodService', $vod->category_id, $vod->id, $service->id], 'method' => 'POST', 'new-vod' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('available') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                {{-- <div class=""> --}}
                                    @php $checkAvailable = 'checked'; if($service->available != 1) $checkAvailable = '' @endphp
                                    {!! Form::input('checkbox', 'available', old('available'), array('id' => 'available', 'class' => 'form-control', 'style' => 'width: 20px; height: 100%;', $checkAvailable)) !!} 
                                {{-- </div> --}}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('duration') ? ' has-error ' : '' }}">
                            {!! Form::label('duration', 'Amount:', array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::input('number', 'duration', $service->duration, array('id' => 'duration', 'class' => 'form-control', 'placeholder' => '30', 'min' => '1', 'max' => '99999', 'step' => '1', 'required')) !!}
                                    <div class="input-group-append">
