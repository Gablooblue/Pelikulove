...
<div class="container">
		...
		<div class="col-lg-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        <div class="div-title" style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                ...
                                <br>    
                                <a href="{{ url('/blackbox-admin/category/' . $vodCategory->id) }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="Back to Category">
                    ...
                    {!! Form::text('formType', 'blackbox-admin-edit-cat', array('id' => 'formType', 'class' => 'form-control', 'hidden')) !!}
                    
                    {!! Form::open(array('route' => ['vodsmanagement.updateCategory', $vodCategory->id], 'method' => 'POST', 'edit-cat' => 'form', 'class' => 'needs-validation')) !!}
                    ...
                    <div class="card-body div-payment-methods">		
                        <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                ...
                                {!! Form::text('name', $vodCategory->name, array('id' => 'name', 'class' => 'form-control', 'placeholder' => 'Category Name', 'required')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                {!! Form::textarea('description', $vodCategory->description, array('id' => 'description', 'class' => 'form-control', 'placeholder' => 'About the service')) !!}
                                    <div class="input-group-append">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('hidden') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                {{-- <div class=""> --}}
                                    ...
                                    {!! Form::input('checkbox', 'hidden', NULL, array('id' => 'hidden', 'class' => 'form-control', 'style' => 'width: 20px; height: 100%;', $checkHidden, 'data-toggle' => "tooltip", 'data-placement' => "top", 'title' => "Hide video from showing on all catalogs")) !!} 
                                {{-- </div> --}}
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <select class="custom-select form-control" name="categoryOrder" id="categoryOrder">
                                        @if ($vodCategories)
                                            @foreach($vodCategories as $vodCategory2)
                                                <option value="{{ $vodCategory2->corder }}" 
                                                    @if ($vodCategory2->id == $vodCategory->id) selected="selected"@endif>
                                                    {{ $vodCategory2->corder }}
                                                </option>
                                            @endforeach
                                        @endif
